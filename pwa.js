...
const cacheName = 'LAWk8SedlacekProject-2021-04-02 11:11:05.926841'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LAWk8SedlacekProject'.length) === 'LAWk8SedlacekProject') {
